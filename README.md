...
- Download the `.exe` file for Windows by clicking on it.

### 2. Run the Installer

- Find the file you just downloaded in your "Downloads" folder or the location you saved it.
- Double-click the `.exe` file. This starts the installation.
- Follow the on-screen steps to install wayback-archiver. Usually, just click "Next" to accept default options.
...
4. Launch wayback-archiver and start using it as you browse.
